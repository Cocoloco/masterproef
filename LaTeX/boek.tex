...
\include{inleiding}
\include{privacyrisicos_bij_klassieke_aanbevelingssystemen}

\include{onderzoek_bestaande_methodes}
\include{privacyvriendelijke_oplossing}
% appendices
\appendix

\bibliographystyle{plainnat-nl}
\bibliography{refbib}{}
